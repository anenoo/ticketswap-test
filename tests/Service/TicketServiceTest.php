...
class TicketServiceTest extends TestCase
{
     ...
     * @test
     */
    public function itShouldBePossibleToCompareTwoTicketForWhileThereIsSimilarBarcodes()
    {
        $ticketA = new Ticket(
     ...
     * @test
     */
    public function itShouldBePossibleToCompareTwoTicketWhileThereIsNoSimilarBarcodes()
    {
        $ticketA = new Ticket(
            new TicketId(id: '6293BB44-3456-4E2A-ACA8-8CDF01AF401B'),
            [
        ...
        $ticketB = new Ticket(
            ...
            [
                new Barcode(type: 'EAN-13', value: '38974312923'),
                new Barcode(type: 'EAN-23', value: '23456789056'),
            ]
        );

        $hasMatch = $this->ticketService->compareBarcodes($ticketA, $ticketB);
        $this->assertFalse($hasMatch, 'Has no similar matched barcodes');
    }
}
