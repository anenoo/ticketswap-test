...
class TomListingOneTicketNoBuyerWithAdministrator
{
     ...
     * @return TomListingOneTicketNoBuyerWithAdministrator
     */
    public function setListing(Listing $listing): TomListingOneTicketNoBuyerWithAdministrator
    {
