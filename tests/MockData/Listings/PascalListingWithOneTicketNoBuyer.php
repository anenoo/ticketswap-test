...
class PascalListingWithOneTicketNoBuyer
{
     ...
     * @return PascalListingWithOneTicketNoBuyer
     */
    public function setListing(Listing $listing): PascalListingWithOneTicketNoBuyer
    {
